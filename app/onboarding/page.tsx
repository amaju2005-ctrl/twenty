...
export default function OnboardingPage() {
  ...
  async function finish() {
    await fetch("/api/profile", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ cvText, target, industries }) });
